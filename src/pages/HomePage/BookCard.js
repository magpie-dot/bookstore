...
const BookCard = ({ book, addProductToCart }) => {
  return (
    <>
      <Card style={{ width: "18rem", margin: "1rem" }}  className={style.card} key={book.id}>
        ...
        <Card.Body className={style.container}>
          ...
          <Button buttonName="Dodaj do koszyka" styleButton="secondary" handleOnClick={() => addProductToCart(book.id)}>
          </Button>
        </Card.Body>
      </Card>
    </>
